  ...
  methods: {
    ...
    toDate: function toDate(date) {
      ...
      if (targe) {
        ...
        this.dayList.find(function (n) {
          if (n.formate === date) _this2.setSelectedDay(n);
        });
      }
    },
...
exports.default = {
  ...
  props: {
    ...
    APP_DOMAIN: {
      type: String,
      default: '//localhost:3000/api/proxy/region'
    }
  },
  methods: {
    /**
    ...
    * */
    open: function open() {
      ...
      if (this.preData.length > 0 && !this.isEdit) {
        var thisV = this;
        var preRanks = thisV.preData.length;
        this.currentIndex = 0;
    ...
    regionPost: function regionPost(data) {
    ...
    pickRegion: function pickRegion(item, preIndex) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        thisV.regionPost({
          ...
          if (preIndex) {
            var preScroll = result.data.lists.findIndex(function (val) {
              return val.dcode === thisV.preData[preIndex].dcode;
            });
            if (preScroll > 4) {
              thisV.picked[thisV.regionType].scrollTop = 32 * (preScroll - 4);
            }
          }
    ...
    switchType: function switchType(index) {
      ...
      this.$nextTick(function () {
        _this.$refs.regionBlock.scrollTop = _this.picked[_this.regionType].scrollTop || 0;
      });
    }
  },
  mounted: function mounted() {
    ...
    this.regionPost({
      ...
      _this2.regionData.province = result.data.lists;
      if (_this2.preData.length > 0) {
        var firstScrollTop = result.data.lists.findIndex(function (val) {
...
exports.default = {
  ...
  methods: {
    deleteValue: function deleteValue(event) {
      var _this = this;
    ...
    doSubmit: function doSubmit(event) {
      this.$emit('doSubmit', event);
    },
    doCancel: function doCancel(event) {
      // noting todo
...
exports.default = {
  ...
  watch: {
    ...
    events: function events(newEvents) {
      // 设置小黑点
      // 先把原有的小黑点清除
      this.curWeeks.forEach(function (value) {
        value.event = false;
      });
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      ...
      try {
        for (var _iterator = newEvents[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          try {
            for (var _iterator2 = this.curWeeks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var day = _step2.value;
  ...
  methods: {
    // 获取下一星期或者上一星期
    getDayList: function getDayList(action) {
      var _this = this;
    ...
    toNextWeek: function toNextWeek() {
      this.action = 'next';
      this.curWeeks = this.getDayList('next');
    },
    toPreWeek: function toPreWeek() {
...
var _searchIcon = __webpack_require__(13);

var _searchIcon2 = _interopRequireDefault(_searchIcon);

var _emptyPage = __webpack_require__(10);

var _emptyPage2 = _interopRequireDefault(_emptyPage);

var _vueTouch = __webpack_require__(15);
...
function install(Vue) {
  ...
  Object.keys(_directives2.default).forEach(function (name) {
    Vue.directive(name, _directives2.default[name]);
  });
  ...
  Vue.component(_region2.default.name, _region2.default);
  Vue.component(_searchInput2.default.name, _searchInput2.default);
  Vue.component(_searchIcon2.default.name, _searchIcon2.default);
  Vue.component(_emptyPage2.default.name, _emptyPage2.default);
}
...
module.exports = "data:image/png;base64,"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('g', {
    ...
    attrs: {
      "d": "M20.5,14 C20.5,10.4101491 17.5898509,7.5 14,7.5 C10.4101491,7.5 7.5,10.4101491 7.5,14 C7.5,17.5898509 10.4101491,20.5 14,20.5 C17.5898509,20.5 20.5,17.5898509 20.5,14 Z M8.5,14 C8.5,10.9624339 10.9624339,8.5 14,8.5 C17.0375661,8.5 19.5,10.9624339 19.5,14 C19.5,17.0375661 17.0375661,19.5 14,19.5 C10.9624339,19.5 8.5,17.0375661 8.5,14 Z",
      "id": "Oval-3"
    }
  }), _vm._v(" "), _c('path', {
    attrs: {
      "d": "M18.2266349,17.5195281 L21.7781746,21.0710678 L21.0710678,21.7781746 L17.5195281,18.2266349 C17.7760475,18.0127976 18.0127976,17.7760475 18.2266349,17.5195281 Z",
      "id": "Combined-Shape"
    }
  })])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "bm-empty-page-text"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "rs-contain addr",
    attrs: {
      "id": "addr' + opts.id + '"
    }
  }, [_c('div', {
    staticClass: "rs-header"
  }, [_c('ul', {
    staticClass: "clearfix addr-tabs"
  }, [_vm._l((_vm.titleDataList), function(item, index) {
    return _c('li', {
      class: [{
        active: index === _vm.currentIndex
      }, 'fl', 'tabs', 'tabs-province'],
      on: {
        "click": function($event) {
          _vm.switchType(index)
        }
      }
    }, [_c('span', {
      staticClass: "f24"
    ...
    staticClass: "shut-down fr",
    staticStyle: {
      "display": "none"
    }
  }, [_vm._v("完成")])], 2)]), _vm._v(" "), _c('div', {
    staticClass: "re-content"
  }, [_c('ul', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.displayBlock),
      expression: "displayBlock"
    }],
    ref: "regionBlock",
    staticClass: "addr-list-nzone clearfix conts-province"
  }, [_c('transition-group', {
    attrs: {
      "name": "fade"
    }
  }, _vm._l((_vm.regionData[_vm.regionType]), function(item) {
    return _c('li', {
      key: item,
      ref: item.dcode,
      refInFor: true,
      ...
      class: {
        active: item.dcode === (_vm.picked[_vm.regionType].data ? _vm.picked[_vm.regionType].data.dcode : false)
      }
    }, [_vm._v(_vm._s(item.dname))])])
  }))], 1)])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "bm-search-input"
  }, [_c('div', {
    staticClass: "bm-search-input-wrapper",
    class: {
      active: _vm.active
    },
    style: ({
      color: (_vm.active ? _vm.activeColor : '#333'),
      borderBottomColor: (_vm.active ? _vm.activeColor : '#999')
    })
  }, [_c('svg', {
  ...
  }, [_c('bm-svg-search-icon', {
    attrs: {
      "color": _vm.active ? _vm.activeColor : '#ccc'
    }
  })], 1), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.submitText))]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
