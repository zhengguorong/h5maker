            ...
            <li class="theme-item">
              <div class="thumb" >
                ...
                <div class="cover">
                  ...
                  <div class="footbar" style="color:#fff;text-align: center;margin-top:50px;cursor: pointer" @click="$router.replace({ path: '/checkAnswer', query: { formId: item._id }})">答卷数量：23</div>
                </div>
              </div>
              <div class="footer">
...
<script>
  ...
  export default {
    ...
    methods: {
      toEditor (item) {
        this.$router.replace({ path: '/formeditor', query: { itemId: item._id } })
      },
