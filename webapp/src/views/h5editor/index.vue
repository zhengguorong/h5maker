<template>
  <div class="editor">
    <HeaderEdit :goback="dialogSave" @saveSuccess="showPreView=true" :perViewAction="save" :openTemplate="true" @template_status="template_status" :isTemplate="editorTheme.isTemplate"/>
