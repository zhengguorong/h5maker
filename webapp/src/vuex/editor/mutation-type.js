...
export const UPDATE_THEME_TITLE = 'UPDATE_THEME_TITLE' // 更新主题标题
...
export const PUSH_BG_LIST = 'PUSH_BG_LIST' // 背景图片列表
export const CLEAN_BG_LIST = 'CLEAN_BG_LIST' // 清除背景图片列表
export const DELETE_THEME = 'DELETE_THEME' // 删除主题
export const SORTELEMENTS_BY_ZINDEX = 'SORTELEMENTS_BY_ZINDEX' // 元素重新排序
export const UPDATE_MUSIC_LIST = 'UPDATE_MUSIC_LIST' // 更新背景音乐列表
export const PUSH_MUSIC_LIST = 'PUSH_MUSIC_LIST' // 添加背景音乐列表
export const CLEAN_MUSIC_LIST = 'CLEAN_MUSIC_LIST' // 清空背景音乐
...
export const PUSH_DEFAULT_MUSIC_LIST = 'PUSH_DEFAULT_MUSIC_LIST' // 添加默认音乐列表
export const SET_DEFAULT_MUSIC_LIST = 'SET_DEFAULT_MUSIC_LIST' // 设置默认音乐列表
export const UPDATE_DEFAULT_MUSIC_LIST = 'UPDATE_DEFAULT_MUSIC_LIST' // 更新默认音乐列表
export const SET_THEME_MUSIC_LIST = 'SET_THEME_MUSIC_LIST' // 设置上传的音乐列表
